...
no_of_subcircuit_input_nodes = 20
no_of_subcircuit_output_nodes = 19
########################################################
...
##########NEW SUBCIRCUITS TO BE CREATED#################
no_of_subcircuit_input_nodes = 15
no_of_subcircuit_output_nodes = 13
total_number_of_unit_subcircuits_for_each_side = 11
            ...
            while optimization_checker_count > 0:
                ...
                with open(pattern_file_path,'r')as fp_file , open(dc_pattern_file_path,'r')as dc_fp_file:
                    ...
                    if (cur_optimized_factor <= best_optimized_factor) and no_of_assign == 0:
                        ...
                        if(best_optimized_factor <= 15.0):
                            trg_normal = "pattern_merge_graphs/best/normal_l_20"
                            trg_dc = "pattern_merge_graphs/best/dc_l_20"
                            shutil.copy2(dc_pattern_file_path, trg_dc)
                            shutil.copy2(pattern_file_path, trg_normal)
...
if 1:
    final_unit_subcircuit_directory_path = "/home/marupust/Desktop/AGG_ANTLR_AMAR/Attributed_graph_Grammar/Antlr/AGL/pattern_merge_graphs/best/dc_l_20/"
    ...
    if(optimized_files_count < unit_sub_circuit_count):
        optimized_files_count = optimized_files_count
