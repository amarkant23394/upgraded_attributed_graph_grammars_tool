    ...
    if 1:
        with open(output_path,'w')as fp_rule_file:
            ...
            for input_rule_num in range(max_inputs):
                fp_rule_file.write("\n\n\trule primary_input_connected_IC_connection_removal_"+str(input_rule_num+1)+" {")
...
#                fp_rule_file.write("\n\t\tdel U2 IC_INSTANCE [ connected = \"1\"](U1.OUT1 -> IN1);");
            ...
            for input_rule_num in range(max_inputs):
                fp_rule_file.write("\n\n\trule nt_connected_IC__connection_removal_"+str(input_rule_num+1)+" {")
...
#                fp_rule_file.write("del U2 IC_INSTANCE [ connected = \"1\"](U1.OUT1 -> IN1);");
            ...
            if 1:
                ...
                for input_rule_num in range(max_inputs):
                    fp_rule_file.write("\n\t\t\tprimary_input_connected_IC_connection_removal_"+str(input_rule_num+1)+" : *;")

                fp_rule_file.write("\n\t\t\tprimary_input_connected_IC_instance_removal : *;")
                for input_rule_num in range(max_inputs):
                    fp_rule_file.write("\n\t\t\tnt_connected_IC__connection_removal_"+str(input_rule_num+1)+" : *;")
