    ...
    def __init__(self,file_path):
        ...
        for index,line in enumerate(unformatted_lines):
            ...
            if line.startswith('dff'):
                ...
                formatted_string = "FDPE {}(.Q({}),.D({}),.C({}),.PRE({}),.CE(1'b1));\n".format(node_number,q_node,d_input,clk,rst)
...
for file_path in pathlib.Path("/home/marupust/Documents/Schematic_generation/input_sub_circuits/").iterdir():
    if file_path.is_file():
        obj = FormatCircuit4Compilation(file_path)
